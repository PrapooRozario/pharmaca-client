...
git clone https://github.com/PrapooRozario/pharmaca-client.git
cd pharmaca-client
...
pharmaca-client/.env.local

VITE_API_URL="your-server-api"
...
VITE_PAYMENT_PUBLISHABLE_KEY="your-stripe-publishable-key"
